 ...
 *
 * On by default in Cloudflare Pages builds (CF_PAGES=1), off everywhere else so `astro dev`,
 * local builds and the screenshot workflow still show the whole site. HOME_ONLY=true or
 * HOME_ONLY=false overrides either way. Applied by src/middleware.ts.
 */
